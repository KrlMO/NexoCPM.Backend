        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    is_active = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    is_deleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    total_attempts = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    is_active = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    is_deleted = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    public_score = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    sub_topic_id = table.Column<int>(type: "int", nullable: true),
                    views_count = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    question_id = table.Column<int>(type: "int", nullable: false),
                    question_content_block_id = table.Column<int>(type: "int", nullable: false),
                    order_index = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ncp_question_context", x => new { x.question_id, x.question_content_block_id });
                    table.ForeignKey(
                        name: "fk_question_content_block_question_context",
                        column: x => x.question_content_block_id,
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "question_content_block_id");
